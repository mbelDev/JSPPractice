		...
		<form action="../board/writting" method="POST">
			<div class="board__wirte-input">
				<div class="board__write-input-title">
					...
					<input type="text" class="board__write-input-txt" name="postTitle">
				</div>
				<div class="board__write-input-author">
					<span class="board__write-input-title-txt">이름</span>
					<input type="text" class="board__write-input-txt" name="postAuth">
				</div>
				...
				<div class="board__write-input-contents">
					...
					<textarea class="board__write-input-txt" id="summernote" name="postCont"></textarea>
				</div>
			</div>

			<div class="board__write-btns">
				<button class="btn btn-write">확인</button>
...
$(document).ready(function () {
	...
	function uploadImage(file,editor){
		...
		const sendData = new FormData(); // key:value <form><input type="file" name="uploadFile"></from>
